...
/**
 * Create JenisPelanggaran Request
 * 
 * Purpose: Validation for creating new jenis pelanggaran
 * Pattern: FormRequest (Laravel)
 * Responsibility: Validation ONLY
 */
class CreateJenisPelanggaranRequest extends FormRequest
{
    /**
     ...
     * 
     * EXACT rules from original controller (lines 51-57)
     */
