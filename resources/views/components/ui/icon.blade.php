...
$icons = [
    ...
    'trash-lines' => '<path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/><line x1="10" x2="10" y1="11" y2="17"/><line x1="14" x2="14" y1="11" y2="17"/>',
    ...
    'shield-x' => '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/><path d="m14.5 9.5-5 5"/><path d="m9.5 9.5 5 5"/>',
    ...
    'archive' => '<path d="m21 8-2 2-1.5-3.7A2 2 0 0 0 15.65 5H8.35a2 2 0 0 0-1.85 1.3L5 10 3 8"/><path d="m3 8 5 13a2 2 0 0 0 1.9 1h4.2a2 2 0 0 0 1.9-1.31L21 8"/><path d="M12 12v5"/>',
    ...
    'checkbox-minus' => '<rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="9" y1="12" x2="15" y2="12"/>',
    'checkbox-checked' => '<rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><path d="m9 12 2 2 4-4"/>',
    ...
    // Education & School
    'graduation' => '<path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 6 3 6 3s3 0 6-3v-5"/>',
    ...
    'id-card' => '<rect x="2" y="5" width="20" height="14" rx="2" ry="2"/><path d="M10 12a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/><path d="M10 12v4"/><path d="M2 12h6"/><path d="M16 9h2"/><path d="M16 13h2"/>',
...
$iconPath = $icons[$name] ?? '<circle cx="12" cy="12" r="10"/>';
@endphp
