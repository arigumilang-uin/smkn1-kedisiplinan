{{-- Tab: Status Akun --}}
<div class="space-y-6" x-data="activityStatusPage()">
    {{-- Filter --}}
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('activityStatusPage', () => ({
            isLoading: false,
            filters: {
            ...
            init() {
                ...
                this.$watch('filters.status', () => this.fetchData());
            ...
            async fetchData(url = null, updatePushState = true) {
                ...
                if (!url) {
                    ...
                    params.append('tab', 'status'); // Force correct tab
                    ...
                    if (!urlObj.searchParams.has('tab')) {
                        urlObj.searchParams.append('tab', 'status');
                    }
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        document.getElementById('status-table-container').innerHTML = html;
                    }
                } catch (error) {
