        ...
        theme: {
            extend: {
                colors: {
                    ...
                    rose: { 500: '#f43f5e' }, 
                    amber: { 500: '#f59e0b', 600: '#d97706' }, // Warning color
                    indigo: { 600: '#4f46e5' }
                },
...
<div class="page-wrap bg-gray-50 min-h-screen p-4 sm:p-6">
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex justify-between items-center mb-3 pb-1 border-b border-gray-200">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Edit Jenis Pelanggaran</h1>
                <p class="text-sm text-gray-500 mt-1">Perbarui detail dasar untuk aturan: <span class="font-semibold text-slate-800">{{ $jenisPelanggaran->nama_pelanggaran }}</span></p>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-100 bg-amber-50/50">
                 <h3 class="text-base font-bold text-slate-700 m-0 flex items-center gap-2">
                     <i class="fas fa-edit text-amber-500"></i> Informasi Dasar
                 </h3>
            </div>
            ...
            <form action="{{ route('jenis-pelanggaran.update', $jenisPelanggaran->id) }}" method="POST">
                ...
                <div class="p-6 space-y-5 bg-slate-50/50">
                    ...
                    <div class="bg-blue-50 border border-blue-200 text-blue-700 px-4 py-3 rounded-xl text-sm shadow-sm flex items-start gap-3">
                        <i class="fas fa-info-circle text-blue-500 text-xl shrink-0 mt-0.5"></i>
                        <div>
                            <strong>Catatan Penting:</strong> Untuk mengatur **Poin, Sanksi, Trigger Surat, dan Pembina**, silakan gunakan halaman **"Kelola Rules"**.
                            <a href="{{ route('frequency-rules.show', $jenisPelanggaran->id) }}" class="text-blue-600 hover:text-blue-800 font-semibold underline block mt-1">
                                <i class="fas fa-external-link-alt mr-1"></i> Lanjut ke Halaman Kelola Rules
                            </a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <small class="text-slate-500 text-xs mt-1 block">Kata kunci alternatif untuk memudahkan pencarian.</small>
                ...
                <div class="px-6 py-4 bg-white border-t border-slate-200 flex justify-end space-x-3">
                    ...
                    <button type="submit" class="px-5 py-2 text-white text-sm font-bold rounded-xl bg-amber-500 hover:bg-amber-600 shadow-lg shadow-amber-200 transition-all transform active:scale-95 flex items-center gap-2">
